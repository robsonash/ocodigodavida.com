  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
            ...
            exit();
                   ...
                   echo 
                    $_SESSION['msgnao'] = '<div class="alert   alert-darger alert-dismissible fade show" role="alert">
  Não foi possivel enviar uma mensagem de confirmação para seu email tente novamente .
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    <span aria-hidden="true">&times;</span>
  </button>
</div>';
